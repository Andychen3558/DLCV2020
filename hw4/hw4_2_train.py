	...
	for epoch in range(num_epochs):
		...
		with torch.no_grad():
			...
			if val_acc/val_num > best_acc:
				...
				print('Best accuracy!')
				torch.save(encoder.state_dict(), './checkpoints/p2_encoder_1.pth')
				torch.save(mlp.state_dict(), './checkpoints/p2_mlp_1.pth')
				torch.save(hallucinator.state_dict(), './checkpoints/p2_hallucinator_1.pth')