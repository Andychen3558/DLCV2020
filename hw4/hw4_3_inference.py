...
if __name__=='__main__':
    ...
    encoder.load_state_dict(torch.load('./checkpoints/p3_encoder_1.pth'))
    mlp.load_state_dict(torch.load('./checkpoints/p3_mlp_1.pth'))
    hallucinator.load_state_dict(torch.load('./checkpoints/p3_hallucinator_1.pth'))
    ...
    # visualization(feature_real, feature_fake, './fig3_2.png')
